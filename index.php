...
<head>
    ...
    <link rel="stylesheet" href="style.css">
     ...
     <link rel="stylesheet" href="assets/css/viewCustomReserve.css">
  ...
  <header class="header">
        <div class="logoContent">
            ...
            <div class="icon">
              ...
              <i  v-if="isLoggedIn"class="fa fa-shopping-cart"onclick="showCart()"></i>
              <i  v-if="isLoggedIn" class="fa fa-bell" aria-hidden="true" id="bell-icon" onclick="showDetails()"></i>
            </div>
    ...
    <div class="box">
        <div class="card" v-for="product in products">
            <div class="small_card">
                ...
                <i class="fa-solid fas fa-eye" @click="fnGetProdcuts(product.id)" data-bs-toggle="modal" data-bs-target="#ViewProduct"></i>
            </div>
            <div class="seller-name">Tanggol</div> 
            <div class="image">
              ...
              <h2>{{ product.productname }}</h2>
                ...
                <div class="products_star">
                    ...
                    <div v-if="product.quantity > 0">
                      <button class="btn btn-primary float-center" @click="fnGetProdcuts(product.id)" data-bs-toggle="modal" data-bs-target="#reserve">Reserve</button>
                      <button class="fa fa-shopping-cart text-dark" style="margin-left:20px; font-size:20px;" data-bs-toggle="modal" data-bs-target="#addtoCart"></button>
                    </div>
                    <div v-else>
                      <div class="product-sold">
                        <p class="sold text-danger">SOLD OUT</p>
                      </div>
                    </div>
            </div>
        </div>
...
<div class="modal fade theme-modal product-modal" id="ViewProduct" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title d-block text-center">Product Details</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    <!-- Product Image -->
                    <div class="col-md-6">
                        <img src="img/cakes.png" alt="Product Image" class="img-fluid rounded">
                    </div>
                    <!-- Product Details -->
                    <div class="col-md-6">
                      <h3 class="mt-3">Sir Tanggol</h3>
                        <h3 class="mt-3">Cake</h3>
                        <p><strong>Product Name:</strong> {{ productname }}</p>
                        <p class="mb-4">Description: Delicious cake that will satisfy your cravings.</p>
                        <p><strong>Stock:</strong> 200</p>
                        <p><strong>Price:</strong> &#8369;50.00</p>
                        <div class="text-center mt-4">
                            <button type="button" class="btn btn-success btn-lg fw-bold">Reserve</button>
                            <button type="button" class="btn btn-primary btn-lg fw-bold ml-2"><i class="fas fa-shopping-cart"></i> Add to Cart</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal-footer bg-light">
                <button type="button" class="btn btn-secondary btn-md fw-bold" data-bs-dismiss="modal">Close</button>
            </div>
        </div>
    </div>
</div>
  ...
  <div class="services_box">
      ...
      <p>
        Enjoy our speedy delivery service, ensuring that your cake arrives fresh and on time for your special occasion.
              ...
              <?php   include 'modals/viewCustomReserve.php'; ?>
    <!-- custom js file  -->
 ...
 <script src="assets/viewCustomReserve.js"></script>
